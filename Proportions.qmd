...
#education births, histogram is also right skewed
...
#median births per year
ggplot(education_avg, aes(x = year, y = median_births, color = education_level, group = education_level)) + geom_point() + geom_line()
```
