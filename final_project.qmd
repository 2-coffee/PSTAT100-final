...
\underbrace{\beta_{11} \text{total\_mort}_i}_{\text{infant mortality}} + \epsilon_i
$$
...
main_popEDU |>
  select(state, region, total_fer, total_mort, edu_gap, income_median, hc_private, hc_public, hc_nohc) |>
  head() |>
  gt() |>
  cols_label(
    state = "State",
    ...
    total_mort = "Total Mortality",
    edu_gap = "Education Gap",
    income_median = "Household Median Income ($)",
    hc_private = "Private Health Coverage",
    hc_public = "Public Health Coverage",
    hc_nohc = "No Health Coverage"
  ) |>
