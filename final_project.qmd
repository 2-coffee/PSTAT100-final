...
-   `total_mort` and `edu_bach` and `edu_grad`: There are moderate negative correlations between total infantmortality rates and higher education. This indicates states with a higher proportion of individuals with higher education have lower total infant mortality rates.
