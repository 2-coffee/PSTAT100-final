...
The variables that are most influential are `edu_bach`, `edu_grad`, `ed_less_hs`, `total_mort`, and `hc_private`. States with high PC1 indicates a relatively higher proportion of residents with private insurance, bachelor degree, and graduate degrees. While states with a lower PC1 value indicates a relatively higher proportion of residents who has less than a high school education and higher infant mortality.
